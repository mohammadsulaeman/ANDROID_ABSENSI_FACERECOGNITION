...
public class UsersAboutItem extends RecyclerView.Adapter<UsersAboutItem.ItemRowHolder>
{
    private Context mContext;
    private List<AboutModel> datalist;
    private int rowLayout;

    public UsersAboutItem(Context mContext, List<AboutModel> datalist, int rowLayout) {
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull UsersAboutItem.ItemRowHolder holder, int position) {
        ...
        holder.kembali.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent a = new Intent(mContext, UsersActivity.class);
    ...
    static class ItemRowHolder extends RecyclerView.ViewHolder{
        ...
        public ItemRowHolder(@NonNull @NotNull View itemView) {
            ...
            phoneklik = itemView.findViewById(R.id.phoneClickUsers);
            logoKlik = itemView.findViewById(R.id.logoklikusers);
            phone = itemView.findViewById(R.id.smartphoneaboutuserstext);
            email = itemView.findViewById(R.id.emailaboutuserstext);
            moto = itemView.findViewById(R.id.motoperusahaanaboutusers);
            alamat = itemView.findViewById(R.id.alamatperusahaanaboutusers);
            kembali = itemView.findViewById(R.id.buttonkembaliklikaboutusers);
