...
public class AdminSupportItem extends RecyclerView.Adapter<AdminSupportItem.ItemRowHolder>
{
    private Context mContext;
    private List<SupportModel> datalist;
    private int rowLayout;

    public AdminSupportItem(Context mContext, List<SupportModel> datalist, int rowLayout) {
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull AdminSupportItem.ItemRowHolder holder, int position) {
    ...
    static class ItemRowHolder extends RecyclerView.ViewHolder{
        ...
        public ItemRowHolder(@NonNull @NotNull View itemView) {
            ...
            profilesuport = itemView.findViewById(R.id.profilesuportadmin);
            github = itemView.findViewById(R.id.gihtubClickadmin);
            portfolio = itemView.findViewById(R.id.portfolioClickadmin);
            nama = itemView.findViewById(R.id.namasupportadmin);
            phone = itemView.findViewById(R.id.phonesupportaboutadmin);
            email = itemView.findViewById(R.id.emailsupportaboutadmin);
            alamat = itemView.findViewById(R.id.alamatsupportaboutadmin);
            kembali = itemView.findViewById(R.id.buttonkembalikliksupportadmin);
        }
    }
}
