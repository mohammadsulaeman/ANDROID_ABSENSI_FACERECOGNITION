package com.example.absensirtj.face.admin;
...
public class AdminFaceRecogActivity extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2 {
    private static String TAG = AdminFaceRecogActivity.class.getSimpleName();
        ...
        if (!uniqueLabelsSet.isEmpty()){
            ...
            mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    Intent main = new Intent(AdminFaceRecogActivity.this, AdminActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_face_recog);
