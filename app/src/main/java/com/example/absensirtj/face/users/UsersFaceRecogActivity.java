package com.example.absensirtj.face.users;
...
import com.example.absensirtj.models.FileUtils;
import com.example.absensirtj.models.Storage;
...
public class UsersFaceRecogActivity extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2 {
    private static String TAG = UsersFaceRecogActivity.class.getSimpleName();
        ...
        if (!uniqueLabelsSet.isEmpty()){
            ...
            mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    Intent main = new Intent(UsersFaceRecogActivity.this, UsersActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_users_face_recog);
        ...
        openCVCamera = (CameraBridgeViewBase)findViewById(R.id.java_camera_view_users);
        openCVCamera.setCameraIndex(CameraBridgeViewBase.CAMERA_ID_FRONT);
        openCVCamera.setVisibility(SurfaceView.VISIBLE);
        openCVCamera.setCvCameraViewListener(this);
        local = new Storage(this);
        mListView = findViewById(R.id.listdataUsers);
        edtNama = findViewById(R.id.editNamakryUsers);
        submit = findViewById(R.id.submitdataUsers);
        headertext = findViewById(R.id.textnamaUsers);
        detect = findViewById(R.id.take_picture_button_users);
