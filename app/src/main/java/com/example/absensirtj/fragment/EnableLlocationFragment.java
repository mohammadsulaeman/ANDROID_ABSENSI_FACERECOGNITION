package com.example.absensirtj.fragment;
...
import com.example.absensirtj.activity.RegisterActivity;
import com.labo.kaji.fragmentanimations.MoveAnimation;
import com.example.absensirtj.constants.BaseApp;
import com.example.absensirtj.R;
import com.example.absensirtj.activity.LoginActivity;
...
public class EnableLlocationFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ImageView viewMap = getView.findViewById(R.id.mapviewlocaction);
        FontDrawable drawableMap = new FontDrawable(context,R.string.fa_map_marked_alt_solid,true,false);
        drawableMap.setTextColor(ContextCompat.getColor(context,R.color.black));
        viewMap.setImageDrawable(drawableMap);
    ...
    public void GoToNext_Activty() {
        ...
        if (user != null) {
            if (!user.getNoTelepon().isEmpty())
            {
                ...
                Intent users = new Intent(getActivity(), RegisterActivity.class);
                startActivity(users);
                getActivity().finish();
            }
        } else {
